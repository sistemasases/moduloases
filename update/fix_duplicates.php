...
$registro_modificar13->id = 104;
$registro_modificar13->id_ases_user = 308;
$registro_modificar13->tracking_status = 0;

echo $DB->update_record('talentospilos_user_extended', $registro_modificar13);

echo '<br>';

$sql_query = "UPDATE {talentospilos_history_academ} SET id_estudiante = 308 WHERE id_estudiante = 890";
$success = $DB->execute($sql_query);

echo $success;
echo '<br>';
$sql_query2 = "UPDATE {talentospilos_demografia} SET id_usuario = 308 WHERE id_usuario = 890";
$success = $DB->execute($sql_query2);
...
echo $success;
echo '<br>';
$sql_query5 = "UPDATE {talentospilos_res_estudiante} SET id_estudiante = 308 WHERE id_estudiante = 890";
$success = $DB->execute($sql_query5);
...
$registro_modificar14->id = 590;
$registro_modificar14->id_ases_user = 1879;
...
$sql_query = "UPDATE {talentospilos_history_academ} SET id_estudiante = 1879 WHERE id_estudiante = 548";
$success = $DB->execute($sql_query);

echo $success;
echo '<br>';
$sql_query2 = "UPDATE {talentospilos_demografia} SET id_usuario = 1879 WHERE id_usuario = 548";
$success = $DB->execute($sql_query2);
...
echo $success;
echo '<br>';
$sql_query5 = "UPDATE {talentospilos_res_estudiante} SET id_estudiante = 1879 WHERE id_estudiante = 548";
$success = $DB->execute($sql_query5);
...
$registro_modificar15->id = 284;
$registro_modificar15->id_ases_user = 1952;
$registro_modificar15->tracking_status = 0;
...
$sql_query = "UPDATE {talentospilos_history_academ} SET id_estudiante = 1952 WHERE id_estudiante = 185";
$success = $DB->execute($sql_query);

echo $success;
echo '<br>';
$sql_query2 = "UPDATE {talentospilos_demografia} SET id_usuario = 1952 WHERE id_usuario = 185";
$success = $DB->execute($sql_query2);
...
echo $success;
echo '<br>';
$sql_query5 = "UPDATE {talentospilos_res_estudiante} SET id_estudiante = 1952 WHERE id_estudiante = 185";
$success = $DB->execute($sql_query5);
