...
const ISSUE_NUMNER = 1766;                                                      // Issue ID on GitHub. Ex. 1569.
const PASSWORD = 1766;                                                          // Null if you want a none secure execution.
...
$script = function(){
  ...
  $programa->nombre = 'MAESTRÍA EN INGENIERÍA DE ALIMENTOS';
  //@var Sede $sede
  ...
  $programa->cod_univalle = 7788;
  $programa->codigosnies = 52085;
  if($programa->save()) {
