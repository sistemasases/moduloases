...
// if($DB->update_record('talentospilos_usuario', $record_to_update) === true){
...
// if($DB->update_record('talentospilos_usuario', $record_to_update1) === true){    
//     echo 'Registro actualizado con éxito';
// }else{
//     echo 'Error';
// }
...
// if($DB->update_record('talentospilos_usuario', $record_to_update2) === true){
//     echo 'Registro actualizado con éxito';
// }else{
//     echo 'Error';
// }
...
// if($DB->delete_records('talentospilos_user_extended', $object_to_delete) === true){
//     echo 'Registro actualizado con éxito';
// }else{
//     echo 'Error';
// }
...
// if($DB->delete_records('talentospilos_user_extended', $object_to_delete1) === true){
//     echo 'Registro actualizado con éxito';
// }else{
//     echo 'Error';
// }
...
// if($DB->delete_records('talentospilos_user_extended', $object_to_delete2) === true){
//     echo 'Registro actualizado con éxito';
// }else{
//     echo 'Error';
// }