...
const ISSUE_NUMNER = 1947;                                                      // Issue ID on GitHub. Ex. 1569.
const PASSWORD = 1947;                                                          // Null if you want a none secure execution.
...
$script = function(){
    ...
    $programa->cod_univalle = 2838;
    $programa->codigosnies = 104201;
    if($programa->save()) {
