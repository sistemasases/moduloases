 ...
 * @property string $mdl_course_caller_id Id of the course where the report is generated
 * @property int $page
 */
...
class ases_grade_report_grader extends grade_report_grader {
    ...
    public $course_id;
    public $course_id_of_instance; // Course id where is the block ASES from this method is called
    public $instance_id;
        ...
        foreach($rows as $row) {
            ...
            foreach($row->cells as &$cell) {
                if(strpos($cell->text, 'username') && strpos($cell->text, 'href')  ) {
                    ...
                    $doc->getElementsByTagName('a')->item(0)->setAttribute('href', $link_general_report_string);
                    /* Change the link for ´a´ of user name*/
                    $doc->getElementsByTagName('a')->item(1)->setAttribute('href', $link_general_report_string);
    ...
    function setup_users()
    {
        ...
        $query = _select_active_ases_users()
...
class API {
    ...
    public function __construct() {
        ...
        $report = new ases_grade_report_grader(
            $this->params->mdl_course_id,
            $this->params->mdl_course_caller_id,
            $this->gpr,
            $context,
