    ...
    $sql_query = "SELECT sexo AS nombre, COUNT(*) AS cantidad FROM
                    ...
                    (SELECT DISTINCT 
                        ...
                        (SELECT 
                            ...
                            $sql_where
                            GROUP BY moodle_user.username, student_id, ases_user.sexo, program_statuses.nombre) AS ases_students $subconsulta_filtros) AS subquery
                    GROUP BY nombre
    ...
    $sql_query = "SELECT edad AS nombre, COUNT(*) AS cantidad FROM
                      ...
                      (SELECT DISTINCT 
                        ...
                        (SELECT 
                            ...
                            GROUP BY moodle_user.username, student_id, edad, program_statuses.nombre) AS ases_students  $subconsulta_filtros) AS subquery
                    GROUP BY nombre
                    ORDER BY cantidad DESC";
    ...
    $sql_query = "SELECT COUNT(*) AS cantidad, nombre, alias FROM
                    ...
                    (SELECT DISTINCT 
                        ...
                        (SELECT 
                                ...
                                INNER JOIN {talentospilos_estad_programa} AS program_statuses ON program_statuses.id = user_extended.program_status 
                                $sql_where
                                GROUP BY moodle_user.username, student_id, ases_user.id_cond_excepcion, program_statuses.nombre) AS ases_students
...
function get_not_assign_students($general_fields=null, $conditions, $academic_fields=null, $instance_id){
    ...
    if(property_exists($actions, 'search_all_students_ar')){
        ...
        $id_current_semester = core_periods_get_current_period()->max;
        ...
        switch($user_role->nombre_rol){
            case 'director_prog':
                ...
                $conditions_query_assigned = " AND ases_students.student_id IN (SELECT id_estudiante AS student_id
                            ...
                            WHERE id_semestre = ". core_periods_get_current_period()->max ." AND id_instancia = $instance_id)";
...
function get_professionals_by_instance($instance_id){
    ...
    $sql_query = "SELECT CONCAT(moodle_user.firstname, CONCAT(' ', moodle_user.lastname)) AS fullname, moodle_user.id
                  ...
                  WHERE id_rol = (SELECT id
                        ...
                        AND id_semestre =". core_periods_get_current_period()->max
                        ."ORDER BY fullname";
