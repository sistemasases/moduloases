...
//se usara para la creacion del toogle
    ...
    //se crea el toogle del profesional el cual tiene cada uno de los practicantesr asignados al profesional
    function crearTablaYToggleProfesional($arregloPracticanteYMonitor) {
        $stringRetornar = "";
...
se usara para la creacion del toogle.*/
 ...
 function transformarConsultaPracticanteArray($pares,$grupal,$arregloMonitores, $instanceid,$role,$id_pract) {
        ...
        for ($monitor=0;$monitor<count($arregloMonitores);$monitor++) {
            ...
            array_push($arregloAuxiliar,monitorUser($pares,$grupal,$arregloMonitores[$monitor][0], $monitor, $instanceid,$role,$id_pract));
...
function monitorUser(&$pares,&$grupal,$codigoMonitor, $noMonitor, $instanceid,$role,$codigoPracticante=null){
...
function crearTablaYToggle($arregloImprimirPares, $monitorNo, $arregloImprimirGrupos, $codigoEnviarN1, $codigoEnviarN2,$rol) {
        $stringRetornar = "";
