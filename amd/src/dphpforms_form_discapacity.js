...
define([
    ...
    'block_ases/jqueryui',
    'block_ases/select2'
], function ($, jszip, dataTables, autoFill, buttons, html5, flash, print, sweetalert, jqueryui, select2) {
    return {
        init: function () {
            ...
            $("#save_ficha_discapacity").on("click", function () {
                ...
                let val_cond_adquisicion, val_apoyo_cotidiano, otro_apoyo_cotidiano, key_apoyo_cotidiano,
                    key_otro_apoyo_cotidiano, otra_cond_adquisicion,
                    descripcion_diagnostico, val_tipo_disc, otro_tipo_disc, val_transporte, otro_transporte,
                    key_transporte, key_otro_transporte, key_otra_condicion_adq,
                    val_participa_asociacion, key_participa_asociacion, val_asoc, key_asoc, porcentaje_invalidez,
                    val_act, key_act, key_realiza_act, val_realiza_act, key_descripcion, check_diagnostico,
                    key_check_diagnostico, json_diagnostico, key_tipo_disc, key_otra_disc, json_tipo_disc,
                    check_certificado, key_check_certificado, json_certificado, key_porcentaje_inv,
                    val_apoyo_institu, key_apoyo_institu, val_apoyo_tipo, key_apoyo_tipo, val_institu, key_institu,
                    key_cond_adquisicion, json_condicion_adq, json_apoyo_institu,
                    json_dif_permanente, json_cond_salud, json_necesidad, json_factores_impacto, json_posibilidad,
                    json_apoyo_cotidiano, json_transporte,
                    json_participa_asoc, json_actividades_otrosm, json_percepcion, key_percepcion_discapacidad = "",
                    descripcion_percepcion;

                //Variables de las opciones de varias respuestas
                var key_func_dp, key_dif_dp, funcion_name, dificult_name, key_org_cs, key_cond_cs, organo_name,
                    condicion_name,
                    key_nec_ns, key_sit_ns, key_factor_fi, factor_name, key_otro_factor_fi, otro_factor_name,
                    key_contexto_fc,
                    key_otro_factor_fc, factor_contexto_name, otro_factor_contexto_name, key_act_pa, actividad_name,
                    posibilidad_name,
                ...
                $("#div_dificultad_permanente").find(":input[type=checkbox]").each(function () {
                    ...
                    if ($(this).is(":checked")) {
                        ...
                        json_dif_permanente = {
                            key_funcion: key_func_dp,
                            funcion: funcion_name,
                            key_dificultad: key_dif_dp,
                            dificultad: dificult_name
                        };
                ...
                $("#div_cond_salud").find(":input[type=checkbox]").each(function () {
                    ...
                    if ($(this).is(":checked")) {
                        ...
                        json_cond_salud = {
                            key_organo: key_org_cs,
                            organo: organo_name,
                            key_condicion: key_cond_cs,
                ...
                $("#div_necesidades").find(":input[type=checkbox]").each(function () {
                    ...
                    if ($(this).is(":checked")) {
                        ...
                        json_necesidad = {
                            key_situacion: key_sit_ns,
                            situacion: situacion_name,
                            key_necesidad: key_nec_ns,
                            necesidad: necesidad_name
                        };
                ...
                $("#div_posibilidades_condiciones").find(":input[type=checkbox]").each(function () {
                    ...
                    if ($(this).is(":checked")) {
                        ...
                        json_posibilidad = {
                            key_actividad: key_act_pa,
                            actividad: actividad_name,
                            key_posibilidad: key_pos_pa,
                            posibilidad: posibilidad_name,
                            key_apoyo: key_apo_pa,
                            tipo_apoyo: tipo_apoyo_name
                        };
