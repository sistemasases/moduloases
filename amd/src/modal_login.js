define(['jquery', 'core/notification', 'core/custom_interaction_events', 'core/modal', 'block_ases/modal_registry'],
    ...
    if (!registered) {
        ModalRegistry.register(ModalLogin.TYPE, ModalLogin, 'block_ases/modal_login');
        registered = true;
    }
