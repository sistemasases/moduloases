    ...
    return {
        init: function () {
            ...
            $(document).on('click', '.summary-title', function () {
                ...
                if (icon.hasClass('ases-glyphicon-chevron-right')) {
                    icon.removeClass("ases-glyphicon-chevron-right");
                    icon.addClass("ases-glyphicon-chevron-down");
                } else {
                    icon.addClass("ases-glyphicon-chevron-right");
                    icon.removeClass("ases-glyphicon-chevron-down");
                }
