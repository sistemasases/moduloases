    ...
    return {
        init: function () {
            ...
            function addHelpMessage() {
                ...
                switch (selector) {
                    case 'matricula':
                        $('#informacion').append('<div class="alert alert-info"><h4 align="center">Información de carga histórico académico</h4><br><strong>Para tener en cuenta...</strong> <br><p>Columnas obligatorias:<ul> <li>codigo_estudiante</li> <li>codigo_programa</li> <li>codigo_materia</li> <li>nombre_materia</li> <li>semestre</li> </ul> </div>');
                        break;
                    case 'academic':
