...
,'pdfmake','vfs_fonts','buttons.html5','buttons.print','sweetalert'], function($){
...
$(document).ready(function() {
    ...
    $.ajax({
        ...
        //para enviar mensajes a los correspondientes monitores
         if(rol==6||(name=="administrador"||name=="sistemas1008"||name=="Administrador"))
         {
            ...
            $(this).on('click','.btn.btn-info.btn-lg.botonModificarSeguimiento', function()
            {
                ...
                //alert(idSeguimientoActualizar)
                //alert(lugar);
                //alert(tema);
                //alert(objetivos);
                //alert("individual")
                //alert(obindividual);
                //alert(riesgoIndividual);
                //alert("familiar")
                //alert(obfamiliar);
                //alert(riesgoFamiliar);
                //alert("academico")
                //alert(obacademico);
                //alert(riesgoAcademico);
                //alert("economico")
                //alert(obeconomico);
                //alert(riesgoEconomico);
                //alert("univers")
                //alert(obuniversitario);
                //alert(riesgoUniversitario);
                //alert(observacionesGeneral);
