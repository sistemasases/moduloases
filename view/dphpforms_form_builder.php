...
include "../classes/output/dphpforms_form_builder_page.php";
...
$PAGE->requires->js_call_amd('block_ases/dphpforms_form_builder', 'init');

$output = $PAGE->get_renderer('block_ases');

echo $output->header();
$dphpforms_form_builder_page = new \block_ases\output\dphpforms_form_builder_page($record);
echo $output->render($dphpforms_form_builder_page);
echo $output->footer();
