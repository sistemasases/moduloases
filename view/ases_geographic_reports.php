...
include("../classes/output/ases_geographic_reports_page.php");
include("../classes/output/renderer.php");

// Set up the page.
$pagetitle = 'Reporte Geográfico ASES';
...
$PAGE->requires->css('/blocks/ases/style/base_ases_style.css', true);
$PAGE->requires->css('/blocks/ases/style/ases_geographic_reports.css', true);
...
$PAGE->requires->js_call_amd('block_ases/ases_geographic_reports','init');
...
$ases_geographic_reports_page = new \block_ases\output\ases_geographic_reports_page($data);

//echo $output->standard_head_html();
echo $output->header();
echo $output->render($ases_geographic_reports_page);
echo $output->footer();
