...
include "../classes/output/test_page.php";
...
$url = new moodle_url("/blocks/ases/view/test.php", array('courseid' => $courseid, 'instanceid' => $instanceid));
...
$PAGE->requires->css('/blocks/ases/style/test.css', true);

$PAGE->requires->js_call_amd('block_ases/test', 'init');

$record->nombre = "SEBASTIAN";

$output = $PAGE->get_renderer('block_ases');

$test_page = new \block_ases\output\test_page($record);

echo $output->header();
echo $output->render($test_page);
echo $output->footer();