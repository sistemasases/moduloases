...
include "../classes/output/dphpforms_form_editor_pregunta_page.php";
include "../classes/output/renderer.php";

$title = "Editor de formularios";
$pagetitle = $title;
$courseid = required_param('courseid', PARAM_INT);
$pregunta_id = required_param('pregunta_id', PARAM_INT);
...
if((get_tipo_campo($record->pregunta->tipo_campo)->campo == 'RADIOBUTTON') || (get_tipo_campo($record->pregunta->tipo_campo)->campo == 'CHECKBOX')){
    $record->radio_or_check = true;
}
...
echo $output->header();
$dphpforms_form_editor_pregunta_page = new \block_ases\output\dphpforms_form_editor_pregunta_page($record);
echo $output->render($dphpforms_form_editor_pregunta_page);
echo $output->footer();
