...
abstract class ExternInfoManager extends Validable {
     ...
     * At this point, all data is valid, otherwise,
    ...
    /**
     * Añadir errores genericos asociados a un objeto guardado en $this->objects,
        ...
        if(!$valid) {
            ...
            if($this->load_data() === true ) {
                ...
                try {
                     ...
                     * un elemento dispara un throw, entonces la transacción será devuelta automaticamente
                     * @see https://docs.moodle.org/dev/Data_manipulation_API#Delegated_transactions
                     *
                     * De echo, si se devuelve de forma explicita, moodle directamente
                     * retornara html indicando el error, pero en este caso eso seria un terrible problema
