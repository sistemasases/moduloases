$(document).ready(function() {
    ...
    $('#AcompaSocio').on('click', '#removeEco', function () {
        ...
        swal({  title: "¿Está seguro/a que desea eliminar esta información económica?",   
...
function loadPsicosocialInfo(idStudent){
    	...
    	$.ajax({
            type: "POST",
            data: {idStudent: idStudent, fun: 'get_professional'},
    	...
    	$.ajax({
            type: "POST",
            data: {idStudent: idStudent, fun: 'get_practicante'},
            url: "../managers/get_info_psicosocial.php",
            success: function(msg){
                console.log(msg);
    	...
    	$.ajax({
            type: "POST",
            data: {idStudent: idStudent, fun: 'get_monitor'},
            url: "../managers/get_info_psicosocial.php",
            success: function(msg){
                console.log(msg);
               $('#monitor_ps').val(msg);
...
function loadRisk(idUser){
    ...
    $.ajax({
        ...
        dataType: "json",
        cache:"false",
        error: function(msg){console.log("Error al cargar el riesgo");}
        });    
...
function loadMotivosRetiros(previous){
    var data = new Array();
    data.push({name:"function",value:"loadMotivos"});
     $.ajax({
        type: "POST",
        data: data,
...
function saveMotivoRetiro(){
    ...
    data.push({name:"function",value:"saveMotivoRetiro"});
    data.push({name:"talentosid",value:talentosid});
    data.push({name:"motivoid",value:motivoid});
    data.push({name:"detalle",value:detalle});
     $.ajax({
        type: "POST",
        data: data,
        url: "../managers/motivos_retiros.php",
...
function riskGraphic(individual_r, familiar_r, economic_r, academic_r, life_r, geo_r){
    ...
    var d = [
    		  [
    			{axis:"Individual",value: individual_r},
    			{axis:"Económico",value: economic_r},
    			{axis:"Familiar",value: familiar_r},
    			{axis:"Vida Universitaria",value: life_r},
    			{axis:"Académico",value: academic_r},
    			{axis:"Geogr��fico",value: geo_r},
...
function get_programa_facultad(idStudent){
    ...
    $.ajax({
       ...
       data: {idStudent: idStudent, fun: 'get_program'},
       success: function(msg){
    ...
    $.ajax({
       type: 'POST',
       url: '../managers/get_programa_facultad.php',
       data: {idStudent: idStudent, fun: 'get_school'},
       success: function(msg){
...
function loadGeograficInfo(){
    ...
    data = new Array();
    data.push({name:"function",value:"load_neighborhood"});
...
function cancel_edition_geographic(){
    swal({  title: "¿Está seguro(a) que desea cancelar?",   
                text: "La información se perderá y no se podrá recuperar",   
                type: "warning",  
                showCancelButton: true,   
                confirmButtonColor: "#d51b23",   
...
function save_geographic(){
    ...
    var data = new Array();
    data.push({name:"function", value:"save_info_geographic"});
    data.push({name:"id_student", value: $('#idtalentos').val()});
    data.push({name:"latitude", value: latitude});
    data.push({name:"length", value: length});
    data.push({name:"id_neighborhood", value: neighborhood_id});
    data.push({name:"geographic_risk", value: risk});
...
function send_email(){
    ...
    data_email.push({name:"function", value:"send_email"});
    data_email.push({name:"id_student_moodle", value: $('#iduser').val()});
    data_email.push({name:"id_student_pilos", value: $('#idtalentos').val()});
    data_email.push({name:"risk_array", value: high_risk_array});
    data_email.push({name:"observations_array", value: observations_array});
    data_email.push({name:"date", value: $('#date').val()});
    data_email.push({name:"url", value: window.location});
